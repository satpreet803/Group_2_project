          ...
          .then(({ data, error }) => {
              ...
              if (data && data.length > 0) {
                  const syncedStudents = data.map(dbStudent => ({
                      ...
                      aadhaar: dbStudent.aadhaar,
                      region: dbStudent.region,
                      ...
                      rankCard: dbStudent.rank_card,
                      addresses: { corr: dbStudent.corr_address, perm: dbStudent.perm_address },
...
function saveStudent(studentData) {
    ...
    if (_supabase) {
        ...
        _supabase.from('students').insert([{
            ...
            corr_address: studentData.addresses?.corr || null,
            perm_address: studentData.addresses?.perm || null,
            ...
            rank_card: studentData.rankCard || null,
